  ...
  return (
      <section className={styles.container__section}>
        <div className={styles.container__img}>
          <Image src={fondo} alt="fondo" className='fondo' priority={true}/>
        </div>
        <div>
          ...
          <div className={styles.container__p}>
            ...
            <button><span><RiDownloadFill /></span><a href='../../public/GuillermoAlbercoCV.pdf' download>Descargar CV </a></button>
          </div>
        </div>
      </section>
  )
