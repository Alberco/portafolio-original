...
import { epic,jardineria,manga,portafolio
...
export const proyectos: Array<Proyectos> = [
    ...
    {id:uuid_v4(),url:"https://portafolioalberco.netlify.app/",caracteristicas:["next","tailwind css"], name: "Portafoliov1", img: portafolio},
